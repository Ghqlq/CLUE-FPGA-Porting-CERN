...
module const_lambda_3_B1_branch (
    ...
    input wire [31:0] in_c4_exe1,
    input wire [0:0] in_c5_exe1,
    ...
    reg [31:0] c0_exe22_reg_q;
    reg [31:0] c0_exe33_reg_q;
    reg [63:0] c0_exe45_reg_q;
    reg [0:0] c0_exe56_reg_q;
    reg [31:0] c0_exe67_reg_q;
    reg [0:0] c0_exe78_reg_q;
    reg [31:0] c1_exe5_reg_q;
    reg [31:0] c4_exe1_reg_q;
    wire [0:0] c5_exe1_cmp_q;
    ...
    // c5_exe1_cmp(LOGICAL,11)
    assign c5_exe1_cmp_q = ~ (in_c5_exe1);

    // valid_out_1_and(LOGICAL,23)
    assign valid_out_1_and_q = in_valid_in & c5_exe1_cmp_q;
    ...
    assign valid_out_0_and_q = in_valid_in & in_c5_exe1;
    ...
    // const_lambda_3_B1_branch_enable(LOGICAL,12)
    ...
    begin
        if (!rst_sync_rst_sclrn[0])
        begin
            c0_exe22_reg_q <= 32'b00000000000000000000000000000000;
        end
        else if (const_lambda_3_B1_branch_enable_q == 1'b1)
        begin
    ...
    begin
        if (!rst_sync_rst_sclrn[0])
        begin
            c0_exe33_reg_q <= 32'b00000000000000000000000000000000;
        end
        else if (const_lambda_3_B1_branch_enable_q == 1'b1)
        begin
    ...
    begin
        if (!rst_sync_rst_sclrn[0])
        begin
            c0_exe67_reg_q <= 32'b00000000000000000000000000000000;
        end
        else if (const_lambda_3_B1_branch_enable_q == 1'b1)
        begin
            c0_exe67_reg_q <= in_c0_exe67;
        end
    end

    // out_c0_exe67(GPOUT,42)
    assign out_c0_exe67 = c0_exe67_reg_q;
    ...
    begin
        if (!rst_sync_rst_sclrn[0])
        begin
            c0_exe78_reg_q <= $unsigned(1'b0);
        end
        else if (const_lambda_3_B1_branch_enable_q == 1'b1)
        begin
            c0_exe78_reg_q <= in_c0_exe78;
        end
    end

    // out_c0_exe78(GPOUT,43)
    assign out_c0_exe78 = c0_exe78_reg_q;
    ...
    begin
        if (!rst_sync_rst_sclrn[0])
        begin
            c4_exe1_reg_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (const_lambda_3_B1_branch_enable_q == 1'b1)
        begin
            c4_exe1_reg_q <= in_c4_exe1;
        end
    end

    // out_c4_exe1(GPOUT,45)
    assign out_c4_exe1 = c4_exe1_reg_q;

    // const_lambda_3_B1_branch_enable_not(LOGICAL,13)
