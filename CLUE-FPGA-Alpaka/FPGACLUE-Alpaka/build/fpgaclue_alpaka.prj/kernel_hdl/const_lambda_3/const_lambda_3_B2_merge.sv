...
// SystemVerilog created from const_lambda_3_B2_merge
...
module const_lambda_3_B2_merge (
    ...
    // out_c0_exe44(GPOUT,7)
    assign out_c0_exe44 = in_c0_exe44_0;

    // out_c1_exe59(GPOUT,8)
    assign out_c1_exe59 = in_c1_exe59_0;
