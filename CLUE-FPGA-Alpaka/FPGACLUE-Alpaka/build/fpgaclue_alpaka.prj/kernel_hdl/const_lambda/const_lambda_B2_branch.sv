...
module const_lambda_B2_branch (
    ...
    reg [0:0] c0_exe35_reg_q;
    reg [0:0] c0_exe46_reg_q;
    reg [31:0] c1_exe1_reg_q;
    wire [0:0] c2_exe1_cmp_q;
    ...
    // c2_exe1_cmp(LOGICAL,7)
    assign c2_exe1_cmp_q = ~ (in_c2_exe1);

    // valid_out_1_and(LOGICAL,19)
    assign valid_out_1_and_q = in_valid_in & c2_exe1_cmp_q;
    ...
    assign valid_out_0_and_q = in_valid_in & in_c2_exe1;
    ...
    // const_lambda_B2_branch_enable(LOGICAL,8)
    ...
    // out_c0_exe35(GPOUT,31)
    assign out_c0_exe35 = c0_exe35_reg_q;
    ...
    // const_lambda_B2_branch_enable_not(LOGICAL,9)
