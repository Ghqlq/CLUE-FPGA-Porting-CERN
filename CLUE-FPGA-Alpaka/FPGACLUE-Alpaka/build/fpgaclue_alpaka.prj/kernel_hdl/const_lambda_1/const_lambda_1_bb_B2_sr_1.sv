...
// SystemVerilog created from bb_const_lambda_1_B2_sr_1
...
module const_lambda_1_bb_B2_sr_1 (
    ...
    // out_o_stall(GPOUT,90)
    assign out_o_stall = sr_valid_q;

    // out_o_valid(GPOUT,91)
    ...
    begin
        if (!resetn)
        begin
            sr_1_x_q <= 32'b00000000000000000000000000000000;
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_3_x_q <= 32'b00000000000000000000000000000000;
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_4_x_q <= 32'b00000000000000000000000000000000;
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_6_x_q <= 32'b00000000000000000000000000000000;
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_7_x_q <= 32'b00000000000000000000000000000000;
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_9_x_q <= 32'b00000000000000000000000000000000;
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_14_x_q <= 32'b00000000000000000000000000000000;
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_18_x_q <= 32'b00000000000000000000000000000000;
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_19_x_q <= 32'b00000000000000000000000000000000;
        end
        else if (not_sr_valid_q == 1'b1)
        begin
