...
// SystemVerilog created from bb_const_lambda_4_B3_stall_region
...
module const_lambda_4_bb_B3_stall_region (
    ...
    input wire [31:0] in_c0_exe110,
    input wire [31:0] in_c0_exe13865,
    input wire [63:0] in_c0_exe220,
    input wire [0:0] in_c0_exe23973,
    input wire [63:0] in_c0_exe329,
    input wire [63:0] in_c0_exe438,
    input wire [0:0] in_c0_exe548,
    input wire [0:0] in_c0_exe658,
    ...
    // sync_out_623(GPOUT,7)@0
    assign out_stall_out = SE_stall_entry_backStall;

    // bubble_join_stall_entry(BITJOIN,11)
    assign bubble_join_stall_entry_q = {in_c0_exe658, in_c0_exe548, in_c0_exe438, in_c0_exe329, in_c0_exe23973, in_c0_exe220, in_c0_exe13865, in_c0_exe110};
    ...
    // sync_out_624(GPOUT,8)@0
    assign out_c0_exe110 = bubble_select_stall_entry_b;
    assign out_c0_exe13865 = bubble_select_stall_entry_c;
    assign out_c0_exe220 = bubble_select_stall_entry_d;
    assign out_c0_exe23973 = bubble_select_stall_entry_e;
    assign out_c0_exe329 = bubble_select_stall_entry_f;
    assign out_c0_exe438 = bubble_select_stall_entry_g;
    assign out_c0_exe548 = bubble_select_stall_entry_h;
    assign out_c0_exe658 = bubble_select_stall_entry_i;
