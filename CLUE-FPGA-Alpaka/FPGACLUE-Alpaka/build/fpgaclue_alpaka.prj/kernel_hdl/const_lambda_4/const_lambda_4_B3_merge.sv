...
// SystemVerilog created from const_lambda_4_B3_merge
...
module const_lambda_4_B3_merge (
    ...
    assign out_c0_exe13865 = in_c0_exe13865_0;

    // out_c0_exe220(GPOUT,15)
    assign out_c0_exe220 = in_c0_exe220_0;

    // out_c0_exe23973(GPOUT,16)
    assign out_c0_exe23973 = in_c0_exe23973_0;

    // out_c0_exe329(GPOUT,17)
    assign out_c0_exe329 = in_c0_exe329_0;

    // out_c0_exe438(GPOUT,18)
    assign out_c0_exe438 = in_c0_exe438_0;

    // out_c0_exe548(GPOUT,19)
    assign out_c0_exe548 = in_c0_exe548_0;

    // out_c0_exe658(GPOUT,20)
    assign out_c0_exe658 = in_c0_exe658_0;
