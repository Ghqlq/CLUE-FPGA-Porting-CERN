...
// SystemVerilog created from const_lambda_4_B2_merge
...
module const_lambda_4_B2_merge (
    ...
    assign out_c0_exe13862 = in_c0_exe13862_0;

    // out_c0_exe16(GPOUT,14)
    assign out_c0_exe16 = in_c0_exe16_0;

    // out_c0_exe216(GPOUT,15)
    assign out_c0_exe216 = in_c0_exe216_0;

    // out_c0_exe23970(GPOUT,16)
    assign out_c0_exe23970 = in_c0_exe23970_0;

    // out_c0_exe325(GPOUT,17)
    assign out_c0_exe325 = in_c0_exe325_0;

    // out_c0_exe434(GPOUT,18)
    assign out_c0_exe434 = in_c0_exe434_0;

    // out_c0_exe544(GPOUT,19)
    assign out_c0_exe544 = in_c0_exe544_0;

    // out_c0_exe654(GPOUT,20)
    assign out_c0_exe654 = in_c0_exe654_0;
