...
module const_lambda_4_B1_merge_reg (
    ...
    output wire [4:0] out_data_out_0_tpl,
    ...
    input wire [4:0] in_data_in_0_tpl,
    ...
    reg [4:0] const_lambda_4_B1_merge_reg_data_reg_0_x_q;
    reg [31:0] const_lambda_4_B1_merge_reg_data_reg_1_x_q;
    ...
    reg [0:0] const_lambda_4_B1_merge_reg_data_reg_5_x_q;
    reg [0:0] const_lambda_4_B1_merge_reg_data_reg_6_x_q;
    ...
    begin
        if (!resetn)
        begin
            const_lambda_4_B1_merge_reg_data_reg_6_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_const_lambda_4_B1_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            const_lambda_4_B1_merge_reg_data_reg_5_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_const_lambda_4_B1_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            const_lambda_4_B1_merge_reg_data_reg_1_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (stall_in_not_or_const_lambda_4_B1_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            const_lambda_4_B1_merge_reg_data_reg_0_x_q <= $unsigned(5'b00000);
        end
        else if (stall_in_not_or_const_lambda_4_B1_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    // sync_out_611_aunroll_x(GPOUT,16)@1
