...
// SystemVerilog created from bb_const_lambda_4_B1_sr_0
...
module const_lambda_4_bb_B1_sr_0 (
    input wire [0:0] in_i_stall,
    input wire [0:0] in_i_valid,
    input wire [4:0] in_i_data_0_tpl,
    ...
    output wire [4:0] out_o_data_0_tpl,
    ...
    // out_o_stall(GPOUT,30)
    assign out_o_stall = sr_valid_q;

    // out_o_valid(GPOUT,31)
