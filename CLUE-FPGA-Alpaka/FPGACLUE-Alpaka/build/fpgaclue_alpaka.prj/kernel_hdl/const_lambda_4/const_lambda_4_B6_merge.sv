...
// SystemVerilog created from const_lambda_4_B6_merge
...
module const_lambda_4_B6_merge (
    ...
    assign out_c0_exe13863 = in_c0_exe13863_0;

    // out_c0_exe18(GPOUT,15)
    assign out_c0_exe18 = in_c0_exe18_0;

    // out_c0_exe218(GPOUT,16)
    assign out_c0_exe218 = in_c0_exe218_0;

    // out_c0_exe23971(GPOUT,17)
    assign out_c0_exe23971 = in_c0_exe23971_0;

    // out_c0_exe327(GPOUT,18)
    assign out_c0_exe327 = in_c0_exe327_0;

    // out_c0_exe436(GPOUT,19)
    assign out_c0_exe436 = in_c0_exe436_0;

    // out_c0_exe546(GPOUT,20)
    assign out_c0_exe546 = in_c0_exe546_0;

    // out_c0_exe656(GPOUT,21)
    assign out_c0_exe656 = in_c0_exe656_0;

    // out_c2_exe174(GPOUT,22)
    assign out_c2_exe174 = in_c2_exe174_0;
