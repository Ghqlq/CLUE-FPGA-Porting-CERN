...
// SystemVerilog created from const_lambda_4_B7_merge
...
module const_lambda_4_B7_merge (
    ...
    assign out_c0_exe13860 = in_c0_exe13860_0;

    // out_c0_exe14(GPOUT,15)
    assign out_c0_exe14 = in_c0_exe14_0;

    // out_c0_exe214(GPOUT,16)
    assign out_c0_exe214 = in_c0_exe214_0;

    // out_c0_exe23968(GPOUT,17)
    assign out_c0_exe23968 = in_c0_exe23968_0;

    // out_c0_exe323(GPOUT,18)
    assign out_c0_exe323 = in_c0_exe323_0;

    // out_c0_exe432(GPOUT,19)
    assign out_c0_exe432 = in_c0_exe432_0;

    // out_c0_exe542(GPOUT,20)
    assign out_c0_exe542 = in_c0_exe542_0;

    // out_c0_exe652(GPOUT,21)
    assign out_c0_exe652 = in_c0_exe652_0;

    // out_c2_exe110175(GPOUT,22)
    assign out_c2_exe110175 = in_c2_exe110175_0;
