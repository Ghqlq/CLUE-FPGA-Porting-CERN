...
// SystemVerilog created from const_lambda_4_B9_branch
...
module const_lambda_4_B9_branch (
    input wire [63:0] in_c0_exe1121,
    ...
    // out_c0_exe1121(GPOUT,10)
    assign out_c0_exe1121 = in_c0_exe1121;

    // out_c0_exe12(GPOUT,11)
    assign out_c0_exe12 = in_c0_exe12;

    // out_c0_exe212(GPOUT,12)
    assign out_c0_exe212 = in_c0_exe212;

    // out_c0_exe540(GPOUT,13)
    assign out_c0_exe540 = in_c0_exe540;

    // out_c0_exe650(GPOUT,14)
