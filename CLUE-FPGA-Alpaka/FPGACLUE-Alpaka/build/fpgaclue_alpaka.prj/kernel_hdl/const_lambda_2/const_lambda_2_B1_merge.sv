...
module const_lambda_2_B1_merge (
    ...
    wire [0:0] c0_exe616_mux_s;
    reg [31:0] c0_exe616_mux_q;
    wire [0:0] c0_exe720_mux_s;
    reg [0:0] c0_exe720_mux_q;
    wire [0:0] c0_exe823_mux_s;
    reg [31:0] c0_exe823_mux_q;
    wire [0:0] c0_exe925_mux_s;
    reg [0:0] c0_exe925_mux_q;
    wire [0:0] i_0_i_i_i_i_i_i_i162_mux_s;
    reg [31:0] i_0_i_i_i_i_i_i_i162_mux_q;
    ...
    // out_c0_exe514(GPOUT,42)
    assign out_c0_exe514 = c0_exe514_mux_q;

    // c0_exe616_mux(MUX,7)
    assign c0_exe616_mux_s = in_valid_in_0;
    always_comb 
    begin
        unique case (c0_exe616_mux_s)
            1'b0 : c0_exe616_mux_q = in_c0_exe616_1;
            1'b1 : c0_exe616_mux_q = in_c0_exe616_0;
            default : c0_exe616_mux_q = 32'b0;
        endcase
    end

    // out_c0_exe616(GPOUT,43)
    assign out_c0_exe616 = c0_exe616_mux_q;
    ...
    // c0_exe925_mux(MUX,10)
    assign c0_exe925_mux_s = in_valid_in_0;
    always_comb 
    begin
        unique case (c0_exe925_mux_s)
            1'b0 : c0_exe925_mux_q = in_c0_exe925_1;
            1'b1 : c0_exe925_mux_q = in_c0_exe925_0;
            default : c0_exe925_mux_q = 1'b0;
        endcase
    end

    // out_c0_exe925(GPOUT,46)
    assign out_c0_exe925 = c0_exe925_mux_q;

    // i_0_i_i_i_i_i_i_i162_mux(MUX,11)
    assign i_0_i_i_i_i_i_i_i162_mux_s = in_valid_in_0;
    always_comb 
    begin
        unique case (i_0_i_i_i_i_i_i_i162_mux_s)
            1'b0 : i_0_i_i_i_i_i_i_i162_mux_q = in_i_0_i_i_i_i_i_i_i162_1;
            1'b1 : i_0_i_i_i_i_i_i_i162_mux_q = in_i_0_i_i_i_i_i_i_i162_0;
            default : i_0_i_i_i_i_i_i_i162_mux_q = 32'b0;
        endcase
    end

    // out_i_0_i_i_i_i_i_i_i162(GPOUT,47)
    assign out_i_0_i_i_i_i_i_i_i162 = i_0_i_i_i_i_i_i_i162_mux_q;
