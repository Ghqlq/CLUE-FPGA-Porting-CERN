...
// SystemVerilog created from bb_const_lambda_2_B2_sr_0
...
module const_lambda_2_bb_B2_sr_0 (
    ...
    begin
        if (!resetn)
        begin
            sr_5_x_q <= 32'b00000000000000000000000000000000;
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_8_x_q <= 32'b00000000000000000000000000000000;
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_16_x_q <= 32'b00000000000000000000000000000000;
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_20_x_q <= 32'b00000000000000000000000000000000;
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_21_x_q <= 32'b00000000000000000000000000000000;
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_22_x_q <= 32'b00000000000000000000000000000000;
        end
        else if (not_sr_valid_q == 1'b1)
        begin
