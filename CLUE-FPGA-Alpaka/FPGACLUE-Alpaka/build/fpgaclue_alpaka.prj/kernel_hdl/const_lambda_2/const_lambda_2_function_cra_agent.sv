...
module const_lambda_2_function_cra_agent (
    ...
    reg [1535:0] pipe_reg0_kernel_arguments_q;
    reg [0:0] pipe_reg0_kernel_start_q;
    reg [1535:0] pipe_reg1_kernel_arguments_q;
    ...
    wire [959:0] dupName_5_arg_bit_join_x_q;
    ...
    wire [95:0] dupName_6_arg_bit_join_x_q;
    ...
    // bit_enable_bottom(BITSELECT,183)
    ...
    // write_selector_start_status(MUX,321)
    ...
    // printf_bit(BITSELECT,279)
    assign printf_bit_b = status_NO_SHIFT_REG_q[3:3];

    // printf_bit_mux(MUX,280)
    ...
    // finish_counter_NO_SHIFT_REG(REG,211)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // readdata_lower_bits_mux(MUX,285)
    ...
    // cra_output_readdata_reg(REG,207)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // avs_cra_readdata(GPOUT,574)
    assign avs_cra_readdata = cra_output_readdata_reg_q;

    // cra_output_readdatavalid_reg(REG,208)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // dupName_12_NO_NAME_x(LOGICAL,399)
    ...
    // bus_high(BITSELECT,188)
    assign bus_high_b = avs_cra_writedata[63:32];

    // bit_enable_top(BITSELECT,185)
    ...
    // bit_enable_top_bar(BITSELECT,186)
    ...
    // global_offset_reg_upper_0_buffered(REG,228)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_upper_0(REG,227)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_lower_0_buffered(REG,222)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_lower_0(REG,221)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // dupName_13_NO_NAME_x(LOGICAL,405)
    ...
    // global_offset_reg_upper_1_buffered(REG,230)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_upper_1(REG,229)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_lower_1_buffered(REG,224)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_lower_1(REG,223)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_upper_2_buffered(REG,232)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_upper_2(REG,231)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_lower_2_buffered(REG,226)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_lower_2(REG,225)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // dupName_7_NO_NAME_x(LOGICAL,369)
    ...
    // global_size_reg_lower_0_buffered(REG,237)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // global_size_reg_lower_0(REG,236)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // global_size_reg_lower_1_buffered(REG,239)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // global_size_reg_lower_1(REG,238)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // dupName_8_NO_NAME_x(LOGICAL,375)
    ...
    // global_size_reg_lower_2_buffered(REG,241)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // global_size_reg_lower_2(REG,240)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // dupName_25_address_ref_x(CONSTANT,478)
    ...
    // dupName_6_arg_bit_join_x(BITJOIN,367)
    assign dupName_6_arg_bit_join_x_q = {arguments_47_q, arguments_46_q, arguments_45_q};

    // dupName_43_mask0_x(LOGICAL,549)
    assign dupName_43_mask0_x_q = bit_enable_bottom_bar_b & arguments_44_buffered_q;

    // dupName_43_new_data_x(LOGICAL,551)
    ...
    // dupName_24_address_ref_x(CONSTANT,472)
    ...
    // dupName_22_address_ref_x(CONSTANT,460)
    ...
    // dupName_23_NO_NAME_x(LOGICAL,465)
    ...
    // dupName_22_NO_NAME_x(LOGICAL,459)
    ...
    // dupName_5_arg_bit_join_x(BITJOIN,359)
    assign dupName_5_arg_bit_join_x_q = {arguments_44_q, arguments_43_q, arguments_42_q, arguments_41_q, arguments_40_q, arguments_39_q, arguments_38_q, arguments_37_q, arguments_36_q, arguments_35_q, arguments_34_q, arguments_33_q, arguments_32_q, arguments_31_q, arguments_30_q, arguments_29_q, arguments_28_q, arguments_27_q, arguments_26_q, arguments_25_q, arguments_24_q, arguments_23_q, arguments_22_q, arguments_21_q, arguments_20_q, arguments_19_q, arguments_18_q, arguments_17_q, arguments_16_q, arguments_15_q};
    ...
    // dupName_4_arg_bit_join_x(BITJOIN,352)
    ...
    // dupName_7_address_ref_x(CONSTANT,370)
    ...
    // dupName_0_arg_bit_join_x(BITJOIN,326)
    assign dupName_0_arg_bit_join_x_q = {arguments_5_q, arguments_4_q};

    // dupName_4_address_ref_x(CONSTANT,347)
    ...
    // kernel_arg_bit_join(BITJOIN,250)
    assign kernel_arg_bit_join_q = {dupName_6_arg_bit_join_x_q, dupName_5_arg_bit_join_x_q, dupName_4_arg_bit_join_x_q, dupName_3_arg_bit_join_x_q, dupName_2_arg_bit_join_x_q, arguments_8_q, dupName_1_arg_bit_join_x_q, dupName_0_arg_bit_join_x_q, arg_bit_join_q, arguments_1_q, arguments_0_q};

    // pipe_reg0_kernel_arguments(REG,275)
    always_ff @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // pipe_reg1_kernel_arguments(REG,277)
    always_ff @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // pipe_reg0_kernel_start(REG,276)
    always_ff @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // pipe_reg1_kernel_start(REG,278)
    always_ff @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // local_size_reg_0_buffered(REG,253)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // local_size_reg_1_buffered(REG,255)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // local_size_reg_2_buffered(REG,257)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // num_groups_reg_0_buffered(REG,269)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // num_groups_reg_1_buffered(REG,271)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // num_groups_reg_2_buffered(REG,273)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // dupName_6_NO_NAME_x(LOGICAL,361)
    ...
    // work_dim_NO_SHIFT_REG_buffered(REG,318)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // workgroup_size_NO_SHIFT_REG_buffered(REG,320)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
    ...
    // workgroup_size_NO_SHIFT_REG(REG,319)
    always_ff @ (posedge clock)
    begin
        if (!resetn)
        begin
