...
//   output_name:       cct_comp_stall_avalon_concatenate_singlebit_conduits_10_jiabaci
//   multibit_width:    5
//
// ------------------------------------------

module cct_comp_stall_avalon_concatenate_singlebit_conduits_10_jiabaci
#(
    parameter MULTIBIT_WIDTH = 5
)
(
