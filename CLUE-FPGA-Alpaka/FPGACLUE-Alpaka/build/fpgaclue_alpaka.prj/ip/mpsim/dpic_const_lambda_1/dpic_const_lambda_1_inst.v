	dpic_const_lambda_1 u0 (
		...
		.agents_ready                     (_connected_to_agents_ready_),                     //   input,   width = 1,         dpi_control_agents_ready.conduit
		.agents_done                      (_connected_to_agents_done_),                      //   input,   width = 1,          dpi_control_agents_done.conduit
		...
		.master_stall                     (_connected_to_master_stall_),                     //  output,   width = 1,                     master_stall.conduit
		.master_done                      (_connected_to_master_done_),                      //   input,   width = 1,                      master_done.conduit
		.start                            (_connected_to_start_),                            //  output,   width = 1,                   component_call.valid
		.ready_in                         (_connected_to_ready_in_),                         //   input,   width = 1,                                 .ready
