// mpsim_ki_altera_mm_interconnect_1920_xrsjtoq.v
...
`timescale 1 ps / 1 ps
module mpsim_ki_altera_mm_interconnect_1920_xrsjtoq (
		...
		input  wire        ctrl_reset_reset_bridge_in_reset_reset,               //         ctrl_reset_reset_bridge_in_reset.reset,        Reset Input
		input  wire        sw_reset_clk_reset_reset_bridge_in_reset_reset,       // sw_reset_clk_reset_reset_bridge_in_reset.reset,        Reset Input
		input  wire        clk_reset_clk_clk                                     //                            clk_reset_clk.clk,          Clock Input
	);
	...
	wire  [179:0] address_span_extender_0_windowed_slave_agent_rf_source_data;                // address_span_extender_0_windowed_slave_agent:rf_source_data -> address_span_extender_0_windowed_slave_agent_rsp_fifo:in_data
	...
	wire  [179:0] address_span_extender_0_windowed_slave_agent_rsp_fifo_out_data;             // address_span_extender_0_windowed_slave_agent_rsp_fifo:out_data -> address_span_extender_0_windowed_slave_agent:rf_sink_data
	...
	wire  [179:0] address_span_extender_0_cntl_agent_rf_source_data;                          // address_span_extender_0_cntl_agent:rf_source_data -> address_span_extender_0_cntl_agent_rsp_fifo:in_data
	...
	wire  [179:0] address_span_extender_0_cntl_agent_rsp_fifo_out_data;                       // address_span_extender_0_cntl_agent_rsp_fifo:out_data -> address_span_extender_0_cntl_agent:rf_sink_data
	...
	wire  [179:0] sw_reset_s_agent_rf_source_data;                                            // sw_reset_s_agent:rf_source_data -> sw_reset_s_agent_rsp_fifo:in_data
	...
	wire  [179:0] sw_reset_s_agent_rsp_fifo_out_data;                                         // sw_reset_s_agent_rsp_fifo:out_data -> sw_reset_s_agent:rf_sink_data
	...
	wire  [143:0] mem_org_mode0_s_agent_rf_source_data;                                       // mem_org_mode0_s_agent:rf_source_data -> mem_org_mode0_s_agent_rsp_fifo:in_data
	...
	wire  [143:0] mem_org_mode0_s_agent_rsp_fifo_out_data;                                    // mem_org_mode0_s_agent_rsp_fifo:out_data -> mem_org_mode0_s_agent:rf_sink_data
	...
	wire  [142:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> mem_org_mode0_s_agent:cp_data
	...
	wire  [143:0] version_id_0_s_agent_rf_source_data;                                        // version_id_0_s_agent:rf_source_data -> version_id_0_s_agent_rsp_fifo:in_data
	...
	wire  [143:0] version_id_0_s_agent_rsp_fifo_out_data;                                     // version_id_0_s_agent_rsp_fifo:out_data -> version_id_0_s_agent:rf_sink_data
	...
	wire  [142:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> version_id_0_s_agent:cp_data
	...
	wire  [142:0] ctrl_m0_agent_cp_data;                                                      // ctrl_m0_agent:cp_data -> router:sink_data
	...
	wire  [178:0] address_span_extender_0_windowed_slave_agent_rp_data;                       // address_span_extender_0_windowed_slave_agent:rp_data -> router_001:sink_data
	...
	wire  [178:0] address_span_extender_0_cntl_agent_rp_data;                                 // address_span_extender_0_cntl_agent:rp_data -> router_002:sink_data
	...
	wire  [178:0] sw_reset_s_agent_rp_data;                                                   // sw_reset_s_agent:rp_data -> router_003:sink_data
	...
	wire  [142:0] mem_org_mode0_s_agent_rp_data;                                              // mem_org_mode0_s_agent:rp_data -> router_004:sink_data
	...
	wire  [142:0] router_004_src_data;                                                        // router_004:src_data -> rsp_demux_003:sink_data
	...
	wire  [142:0] version_id_0_s_agent_rp_data;                                               // version_id_0_s_agent:rp_data -> router_005:sink_data
	...
	wire  [142:0] router_005_src_data;                                                        // router_005:src_data -> rsp_demux_004:sink_data
	...
	wire  [142:0] router_src_data;                                                            // router:src_data -> ctrl_m0_limiter:cmd_sink_data
	...
	wire  [142:0] ctrl_m0_limiter_cmd_src_data;                                               // ctrl_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [142:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> ctrl_m0_limiter:rsp_sink_data
	...
	wire  [142:0] ctrl_m0_limiter_rsp_src_data;                                               // ctrl_m0_limiter:rsp_src_data -> ctrl_m0_agent:rp_data
	...
	wire  [142:0] cmd_demux_src1_data;                                                        // cmd_demux:src1_data -> cmd_mux_001:sink0_data
	...
	wire  [142:0] cmd_demux_src3_data;                                                        // cmd_demux:src3_data -> cmd_mux_003:sink0_data
	...
	wire  [142:0] cmd_demux_src4_data;                                                        // cmd_demux:src4_data -> cmd_mux_004:sink0_data
	...
	wire  [142:0] rsp_demux_001_src0_data;                                                    // rsp_demux_001:src0_data -> rsp_mux:sink1_data
	...
	wire  [142:0] rsp_demux_003_src0_data;                                                    // rsp_demux_003:src0_data -> rsp_mux:sink3_data
	...
	wire  [142:0] rsp_demux_004_src0_data;                                                    // rsp_demux_004:src0_data -> rsp_mux:sink4_data
	...
	wire  [142:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> address_span_extender_0_windowed_slave_cmd_width_adapter:in_data
	...
	wire  [178:0] address_span_extender_0_windowed_slave_cmd_width_adapter_src_data;          // address_span_extender_0_windowed_slave_cmd_width_adapter:out_data -> address_span_extender_0_windowed_slave_agent:cp_data
	...
	wire  [142:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> address_span_extender_0_cntl_cmd_width_adapter:in_data
	...
	wire  [178:0] address_span_extender_0_cntl_cmd_width_adapter_src_data;                    // address_span_extender_0_cntl_cmd_width_adapter:out_data -> address_span_extender_0_cntl_agent:cp_data
	...
	wire  [142:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> sw_reset_s_cmd_width_adapter:in_data
	...
	wire  [178:0] sw_reset_s_cmd_width_adapter_src_data;                                      // sw_reset_s_cmd_width_adapter:out_data -> sw_reset_s_agent:cp_data
	...
	wire  [178:0] router_001_src_data;                                                        // router_001:src_data -> address_span_extender_0_windowed_slave_rsp_width_adapter:in_data
	...
	wire  [142:0] address_span_extender_0_windowed_slave_rsp_width_adapter_src_data;          // address_span_extender_0_windowed_slave_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [178:0] router_002_src_data;                                                        // router_002:src_data -> address_span_extender_0_cntl_rsp_width_adapter:in_data
	...
	wire  [142:0] address_span_extender_0_cntl_rsp_width_adapter_src_data;                    // address_span_extender_0_cntl_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire  [178:0] router_003_src_data;                                                        // router_003:src_data -> sw_reset_s_rsp_width_adapter:in_data
	...
	wire  [142:0] sw_reset_s_rsp_width_adapter_src_data;                                      // sw_reset_s_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	...
	mpsim_ki_altera_merlin_master_translator_193_lgcew2q #(
		.AV_ADDRESS_W                (14),
		.AV_DATA_W                   (32),
		.AV_BURSTCOUNT_W             (1),
		.AV_BYTEENABLE_W             (4),
	...
	mpsim_ki_altera_merlin_master_agent_1940_r3ep6da #(
		.PKT_WUNIQUE               (97),
		.PKT_DOMAIN_H              (96),
		.PKT_DOMAIN_L              (95),
		.PKT_SNOOP_H               (94),
		...
		.PKT_AWATOP_H              (121),
		.PKT_AWATOP_L              (116),
		.PKT_AWSTASHNID_H          (132),
		.PKT_AWSTASHNID_L          (122),
		.PKT_AWSTASHNIDEN          (133),
		.PKT_AWSTASHLPID_H         (138),
		.PKT_AWSTASHLPID_L         (134),
		.PKT_AWSTASHLPIDEN         (139),
		.PKT_MMUSECSID             (141),
		.PKT_MMUSID_H              (140),
		.PKT_MMUSID_L              (140),
		.PKT_DATALESS              (142),
		...
		.cp_data               (ctrl_m0_agent_cp_data),                                      //  output,  width = 143,          .data
		...
		.rp_data               (ctrl_m0_limiter_rsp_src_data),                               //   input,  width = 143,          .data
	...
	mpsim_ki_altera_merlin_slave_agent_1930_jxauz3i #(
		...
		.PKT_AWATOP_H              (157),
		.PKT_AWATOP_L              (152),
		.PKT_AWSTASHNID_H          (168),
		.PKT_AWSTASHNID_L          (158),
		.PKT_AWSTASHNIDEN          (169),
		.PKT_AWSTASHLPID_H         (174),
		.PKT_AWSTASHLPID_L         (170),
		.PKT_AWSTASHLPIDEN         (175),
		.PKT_MMUSECSID             (177),
		.PKT_MMUSID_H              (176),
		.PKT_MMUSID_L              (176),
		.PKT_DATALESS              (178),
		...
		.rp_data                 (address_span_extender_0_windowed_slave_agent_rp_data),                       //  output,  width = 179,                .data
		...
		.cp_data                 (address_span_extender_0_windowed_slave_cmd_width_adapter_src_data),          //   input,  width = 179,                .data
		...
		.rf_sink_data            (address_span_extender_0_windowed_slave_agent_rsp_fifo_out_data),             //   input,  width = 180,                .data
		...
		.rf_source_data          (address_span_extender_0_windowed_slave_agent_rf_source_data),                //  output,  width = 180,                .data
	...
	mpsim_ki_altera_avalon_sc_fifo_1932_onpcouq #(
		...
		.clk               (clk_reset_clk_clk),                                                       //   input,    width = 1,       clk.clk
		.reset             (ctrl_reset_reset_bridge_in_reset_reset),                                  //   input,    width = 1, clk_reset.reset
		.in_data           (address_span_extender_0_windowed_slave_agent_rf_source_data),             //   input,  width = 180,        in.data
		...
		.out_data          (address_span_extender_0_windowed_slave_agent_rsp_fifo_out_data),          //  output,  width = 180,       out.data
	...
	mpsim_ki_altera_merlin_slave_agent_1930_jxauz3i #(
		...
		.rp_data                 (address_span_extender_0_cntl_agent_rp_data),                       //  output,  width = 179,                .data
		...
		.cp_data                 (address_span_extender_0_cntl_cmd_width_adapter_src_data),          //   input,  width = 179,                .data
		...
		.rf_sink_data            (address_span_extender_0_cntl_agent_rsp_fifo_out_data),             //   input,  width = 180,                .data
		...
		.rf_source_data          (address_span_extender_0_cntl_agent_rf_source_data),                //  output,  width = 180,                .data
	...
	mpsim_ki_altera_avalon_sc_fifo_1932_onpcouq #(
		...
		.clk               (clk_reset_clk_clk),                                             //   input,    width = 1,       clk.clk
		.reset             (ctrl_reset_reset_bridge_in_reset_reset),                        //   input,    width = 1, clk_reset.reset
		.in_data           (address_span_extender_0_cntl_agent_rf_source_data),             //   input,  width = 180,        in.data
		...
		.out_data          (address_span_extender_0_cntl_agent_rsp_fifo_out_data),          //  output,  width = 180,       out.data
	...
	mpsim_ki_altera_merlin_slave_agent_1930_jxauz3i #(
		...
		.rp_data                 (sw_reset_s_agent_rp_data),                       //  output,  width = 179,                .data
		...
		.cp_data                 (sw_reset_s_cmd_width_adapter_src_data),          //   input,  width = 179,                .data
		...
		.rf_sink_data            (sw_reset_s_agent_rsp_fifo_out_data),             //   input,  width = 180,                .data
		...
		.rf_source_data          (sw_reset_s_agent_rf_source_data),                //  output,  width = 180,                .data
	...
	mpsim_ki_altera_avalon_sc_fifo_1932_onpcouq #(
		...
		.clk               (clk_reset_clk_clk),                              //   input,    width = 1,       clk.clk
		.reset             (sw_reset_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (sw_reset_s_agent_rf_source_data),                //   input,  width = 180,        in.data
		...
		.out_data          (sw_reset_s_agent_rsp_fifo_out_data),             //  output,  width = 180,       out.data
	...
	mpsim_ki_altera_merlin_slave_agent_1930_jxauz3i #(
		...
		.rp_data                 (mem_org_mode0_s_agent_rp_data),                    //  output,  width = 143,                .data
		...
		.cp_data                 (cmd_mux_003_src_data),                             //   input,  width = 143,                .data
		...
		.rf_sink_data            (mem_org_mode0_s_agent_rsp_fifo_out_data),          //   input,  width = 144,                .data
		...
		.rf_source_data          (mem_org_mode0_s_agent_rf_source_data),             //  output,  width = 144,                .data
	...
	mpsim_ki_altera_avalon_sc_fifo_1932_onpcouq #(
		...
		.clk               (clk_reset_clk_clk),                                //   input,    width = 1,       clk.clk
		.reset             (ctrl_reset_reset_bridge_in_reset_reset),           //   input,    width = 1, clk_reset.reset
		.in_data           (mem_org_mode0_s_agent_rf_source_data),             //   input,  width = 144,        in.data
		...
		.out_data          (mem_org_mode0_s_agent_rsp_fifo_out_data),          //  output,  width = 144,       out.data
	...
	mpsim_ki_altera_merlin_slave_agent_1930_jxauz3i #(
		...
		.rp_data                 (version_id_0_s_agent_rp_data),                    //  output,  width = 143,                .data
		...
		.cp_data                 (cmd_mux_004_src_data),                            //   input,  width = 143,                .data
		...
		.rf_sink_data            (version_id_0_s_agent_rsp_fifo_out_data),          //   input,  width = 144,                .data
		...
		.rf_source_data          (version_id_0_s_agent_rf_source_data),             //  output,  width = 144,                .data
	...
	mpsim_ki_altera_avalon_sc_fifo_1932_onpcouq #(
		...
		.clk               (clk_reset_clk_clk),                               //   input,    width = 1,       clk.clk
		.reset             (ctrl_reset_reset_bridge_in_reset_reset),          //   input,    width = 1, clk_reset.reset
		.in_data           (version_id_0_s_agent_rf_source_data),             //   input,  width = 144,        in.data
		...
		.out_data          (version_id_0_s_agent_rsp_fifo_out_data),          //  output,  width = 144,       out.data
	...
	mpsim_ki_altera_merlin_router_1921_qtz4nay router_001 (
		...
		.sink_data          (address_span_extender_0_windowed_slave_agent_rp_data),          //   input,  width = 179,          .data
	...
	mpsim_ki_altera_merlin_router_1921_qtz4nay router_002 (
		...
		.sink_data          (address_span_extender_0_cntl_agent_rp_data),          //   input,  width = 179,          .data
	...
	mpsim_ki_altera_merlin_router_1921_5eormgy router_004 (
		...
		.sink_data          (mem_org_mode0_s_agent_rp_data),          //   input,  width = 143,          .data
		...
		.src_data           (router_004_src_data),                    //  output,  width = 143,          .data
	...
	mpsim_ki_altera_merlin_router_1921_5eormgy router_005 (
		...
		.sink_data          (version_id_0_s_agent_rp_data),           //   input,  width = 143,          .data
		...
		.src_data           (router_005_src_data),                    //  output,  width = 143,          .data
	...
	mpsim_ki_altera_merlin_traffic_limiter_1921_3mmasty #(
		...
		.cmd_src_data           (ctrl_m0_limiter_cmd_src_data),           //  output,  width = 143,          .data
		...
		.rsp_src_data           (ctrl_m0_limiter_rsp_src_data),           //  output,  width = 143,          .data
	...
	mpsim_ki_altera_merlin_demultiplexer_1921_i7haooa cmd_demux (
		.clk                (clk_reset_clk_clk),                      //   input,    width = 1,        clk.clk
		.reset              (ctrl_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		...
		.sink_data          (ctrl_m0_limiter_cmd_src_data),           //   input,  width = 143,           .data
		...
		.src3_data          (cmd_demux_src3_data),                    //  output,  width = 143,           .data
		...
		.src4_data          (cmd_demux_src4_data),                    //  output,  width = 143,           .data
	...
	mpsim_ki_altera_merlin_multiplexer_1922_yh2hzlq cmd_mux (
		.clk                 (clk_reset_clk_clk),                      //   input,    width = 1,       clk.clk
		.reset               (ctrl_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	mpsim_ki_altera_merlin_multiplexer_1922_yh2hzlq cmd_mux_001 (
		.clk                 (clk_reset_clk_clk),                      //   input,    width = 1,       clk.clk
		.reset               (ctrl_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (cmd_demux_src1_data),                    //   input,  width = 143,          .data
	...
	mpsim_ki_altera_merlin_multiplexer_1922_yh2hzlq cmd_mux_002 (
		.clk                 (clk_reset_clk_clk),                              //   input,    width = 1,       clk.clk
		.reset               (sw_reset_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	mpsim_ki_altera_merlin_multiplexer_1922_yh2hzlq cmd_mux_003 (
		.clk                 (clk_reset_clk_clk),                      //   input,    width = 1,       clk.clk
		.reset               (ctrl_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_003_src_ready),                  //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_003_src_valid),                  //  output,    width = 1,          .valid
		.src_data            (cmd_mux_003_src_data),                   //  output,  width = 143,          .data
		...
		.sink0_data          (cmd_demux_src3_data),                    //   input,  width = 143,          .data
	...
	mpsim_ki_altera_merlin_multiplexer_1922_yh2hzlq cmd_mux_004 (
		.clk                 (clk_reset_clk_clk),                      //   input,    width = 1,       clk.clk
		.reset               (ctrl_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_004_src_ready),                  //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_004_src_valid),                  //  output,    width = 1,          .valid
		.src_data            (cmd_mux_004_src_data),                   //  output,  width = 143,          .data
		...
		.sink0_data          (cmd_demux_src4_data),                    //   input,  width = 143,          .data
	...
	mpsim_ki_altera_merlin_demultiplexer_1921_suap5yy rsp_demux (
		.clk                (clk_reset_clk_clk),                                                          //   input,    width = 1,       clk.clk
		.reset              (ctrl_reset_reset_bridge_in_reset_reset),                                     //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (address_span_extender_0_windowed_slave_rsp_width_adapter_src_data),          //   input,  width = 143,          .data
	...
	mpsim_ki_altera_merlin_demultiplexer_1921_suap5yy rsp_demux_001 (
		.clk                (clk_reset_clk_clk),                                                //   input,    width = 1,       clk.clk
		.reset              (ctrl_reset_reset_bridge_in_reset_reset),                           //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (address_span_extender_0_cntl_rsp_width_adapter_src_data),          //   input,  width = 143,          .data
	...
	mpsim_ki_altera_merlin_demultiplexer_1921_suap5yy rsp_demux_002 (
		.clk                (clk_reset_clk_clk),                              //   input,    width = 1,       clk.clk
		.reset              (sw_reset_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (sw_reset_s_rsp_width_adapter_src_data),          //   input,  width = 143,          .data
	...
	mpsim_ki_altera_merlin_demultiplexer_1921_suap5yy rsp_demux_003 (
		...
		.src0_data          (rsp_demux_003_src0_data),                //  output,  width = 143,          .data
	...
	mpsim_ki_altera_merlin_demultiplexer_1921_suap5yy rsp_demux_004 (
		...
		.src0_data          (rsp_demux_004_src0_data),                //  output,  width = 143,          .data
	...
	mpsim_ki_altera_merlin_multiplexer_1922_pzwq76q rsp_mux (
		.clk                 (clk_reset_clk_clk),                      //   input,    width = 1,       clk.clk
		.reset               (ctrl_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink1_data          (rsp_demux_001_src0_data),                //   input,  width = 143,          .data
		...
		.sink3_data          (rsp_demux_003_src0_data),                //   input,  width = 143,          .data
		...
		.sink4_data          (rsp_demux_004_src0_data),                //   input,  width = 143,          .data
	...
	mpsim_ki_altera_merlin_width_adapter_1961_6vhpr3q #(
		.IN_PKT_ADDR_H                 (49),
		.IN_PKT_ADDR_L                 (36),
		.IN_PKT_DATA_H                 (31),
		.IN_PKT_DATA_L                 (0),
		...
		.IN_PKT_DATACHK_H              (99),
		.IN_PKT_DATACHK_L              (99),
		.IN_PKT_ADDRCHK_H              (102),
		.IN_PKT_ADDRCHK_L              (101),
		.IN_PKT_SAI_H                  (103),
		.IN_PKT_SAI_L                  (103),
		.IN_PKT_AWAKEUP                (115),
		.IN_PKT_ATRACE                 (113),
		.IN_PKT_TRACE                  (114),
		.IN_PKT_USER_DATA_H            (100),
		.IN_PKT_USER_DATA_L            (100),
		.IN_ST_DATA_W                  (143),
		.OUT_PKT_ADDR_H                (85),
		.OUT_PKT_ADDR_L                (72),
		.OUT_PKT_DATA_H                (63),
		...
		.OUT_PKT_POISON_H              (134),
		.OUT_PKT_POISON_L              (134),
		.OUT_PKT_DATACHK_H             (135),
		.OUT_PKT_DATACHK_L             (135),
		.OUT_PKT_ADDRCHK_H             (138),
		.OUT_PKT_ADDRCHK_L             (137),
		.OUT_PKT_SAI_H                 (139),
		.OUT_PKT_SAI_L                 (139),
		.OUT_PKT_AWAKEUP               (151),
		.OUT_PKT_ATRACE                (149),
		...
		.OUT_PKT_EOP_OOO               (140),
		.OUT_PKT_SOP_OOO               (141),
		.OUT_PKT_USER_DATA_H           (136),
		.OUT_PKT_USER_DATA_L           (136),
		.IN_PKT_AWATOP_L               (116),
		.IN_PKT_AWATOP_H               (121),
		.IN_PKT_AWSTASHNID_L           (122),
		.IN_PKT_AWSTASHNID_H           (132),
		.IN_PKT_AWSTASHNIDEN           (133),
		.IN_PKT_AWSTASHLPID_L          (134),
		.IN_PKT_AWSTASHLPID_H          (138),
		.IN_PKT_AWSTASHLPIDEN          (139),
		.IN_PKT_MMUSECSID              (141),
		.IN_PKT_MMUSID_L               (140),
		.IN_PKT_MMUSID_H               (140),
		.IN_PKT_DATALESS               (142),
		.OUT_PKT_AWATOP_L              (152),
		.OUT_PKT_AWATOP_H              (157),
		.OUT_PKT_AWSTASHNID_L          (158),
		.OUT_PKT_AWSTASHNID_H          (168),
		.OUT_PKT_AWSTASHNIDEN          (169),
		.OUT_PKT_AWSTASHLPID_L         (170),
		.OUT_PKT_AWSTASHLPID_H         (174),
		.OUT_PKT_AWSTASHLPIDEN         (175),
		.OUT_PKT_MMUSECSID             (177),
		.OUT_PKT_MMUSID_L              (176),
		.OUT_PKT_MMUSID_H              (176),
		.OUT_PKT_DATALESS              (178),
		.ENABLE_OOO                    (0),
		.OUT_ST_DATA_W                 (179),
		.ST_CHANNEL_W                  (5),
		.OPTIMIZE_FOR_RSP              (0),
		...
		.out_data             (address_span_extender_0_windowed_slave_cmd_width_adapter_src_data),          //  output,  width = 179,          .data
	...
	mpsim_ki_altera_merlin_width_adapter_1961_6vhpr3q #(
		...
		.out_data             (address_span_extender_0_cntl_cmd_width_adapter_src_data),          //  output,  width = 179,          .data
	...
	mpsim_ki_altera_merlin_width_adapter_1961_6vhpr3q #(
		...
		.in_data              (cmd_mux_002_src_data),                           //   input,  width = 143,          .data
		.out_endofpacket      (sw_reset_s_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (sw_reset_s_cmd_width_adapter_src_data),          //  output,  width = 179,          .data
	...
	mpsim_ki_altera_merlin_width_adapter_1961_l6mghii #(
		.IN_PKT_ADDR_H                 (85),
		.IN_PKT_ADDR_L                 (72),
		.IN_PKT_DATA_H                 (63),
		.IN_PKT_DATA_L                 (0),
		...
		.IN_PKT_POISON_H               (134),
		.IN_PKT_POISON_L               (134),
		.IN_PKT_DATACHK_H              (135),
		.IN_PKT_DATACHK_L              (135),
		.IN_PKT_ADDRCHK_H              (138),
		.IN_PKT_ADDRCHK_L              (137),
		.IN_PKT_SAI_H                  (139),
		.IN_PKT_SAI_L                  (139),
		.IN_PKT_AWAKEUP                (151),
		.IN_PKT_ATRACE                 (149),
		.IN_PKT_TRACE                  (150),
		.IN_PKT_USER_DATA_H            (136),
		.IN_PKT_USER_DATA_L            (136),
		.IN_ST_DATA_W                  (179),
		.OUT_PKT_ADDR_H                (49),
		.OUT_PKT_ADDR_L                (36),
		.OUT_PKT_DATA_H                (31),
		...
		.OUT_PKT_POISON_H              (98),
		.OUT_PKT_POISON_L              (98),
		.OUT_PKT_DATACHK_H             (99),
		.OUT_PKT_DATACHK_L             (99),
		.OUT_PKT_ADDRCHK_H             (102),
		.OUT_PKT_ADDRCHK_L             (101),
		.OUT_PKT_SAI_H                 (103),
		.OUT_PKT_SAI_L                 (103),
		.OUT_PKT_AWAKEUP               (115),
		.OUT_PKT_ATRACE                (113),
		...
		.OUT_PKT_EOP_OOO               (104),
		.OUT_PKT_SOP_OOO               (105),
		.OUT_PKT_USER_DATA_H           (100),
		.OUT_PKT_USER_DATA_L           (100),
		.IN_PKT_AWATOP_L               (152),
		.IN_PKT_AWATOP_H               (157),
		.IN_PKT_AWSTASHNID_L           (158),
		.IN_PKT_AWSTASHNID_H           (168),
		.IN_PKT_AWSTASHNIDEN           (169),
		.IN_PKT_AWSTASHLPID_L          (170),
		.IN_PKT_AWSTASHLPID_H          (174),
		.IN_PKT_AWSTASHLPIDEN          (175),
		.IN_PKT_MMUSECSID              (177),
		.IN_PKT_MMUSID_L               (176),
		.IN_PKT_MMUSID_H               (176),
		.IN_PKT_DATALESS               (178),
		.OUT_PKT_AWATOP_L              (116),
		.OUT_PKT_AWATOP_H              (121),
		.OUT_PKT_AWSTASHNID_L          (122),
		.OUT_PKT_AWSTASHNID_H          (132),
		.OUT_PKT_AWSTASHNIDEN          (133),
		.OUT_PKT_AWSTASHLPID_L         (134),
		.OUT_PKT_AWSTASHLPID_H         (138),
		.OUT_PKT_AWSTASHLPIDEN         (139),
		.OUT_PKT_MMUSECSID             (141),
		.OUT_PKT_MMUSID_L              (140),
		.OUT_PKT_MMUSID_H              (140),
		.OUT_PKT_DATALESS              (142),
		.ENABLE_OOO                    (0),
		.OUT_ST_DATA_W                 (143),
		.ST_CHANNEL_W                  (5),
		.OPTIMIZE_FOR_RSP              (1),
		...
		.out_data             (address_span_extender_0_windowed_slave_rsp_width_adapter_src_data),          //  output,  width = 143,          .data
	...
	mpsim_ki_altera_merlin_width_adapter_1961_l6mghii #(
		...
		.out_data             (address_span_extender_0_cntl_rsp_width_adapter_src_data),          //  output,  width = 143,          .data
	...
	mpsim_ki_altera_merlin_width_adapter_1961_l6mghii #(
		...
		.in_data              (router_003_src_data),                            //   input,  width = 179,          .data
		.out_endofpacket      (sw_reset_s_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (sw_reset_s_rsp_width_adapter_src_data),          //  output,  width = 143,          .data
