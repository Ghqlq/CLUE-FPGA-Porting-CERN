// mpsim_ki_altera_mm_interconnect_1920_drc2cja.v
...
`timescale 1 ps / 1 ps
module mpsim_ki_altera_mm_interconnect_1920_drc2cja (
		...
		input  wire        address_span_extender_0_reset_reset_bridge_in_reset_reset, // address_span_extender_0_reset_reset_bridge_in_reset.reset,        Reset Input
		input  wire        kernel_cra_reset_reset_bridge_in_reset_reset,              //              kernel_cra_reset_reset_bridge_in_reset.reset,        Reset Input
		input  wire        clk_reset_clk_clk,                                         //                                       clk_reset_clk.clk,          Clock Input
		input  wire        kernel_clk_out_clk_clk                                     //                                  kernel_clk_out_clk.clk,          Clock Input
	);
	...
	wire  [190:0] rsp_mux_src_data;                                                                           // rsp_mux:src_data -> address_span_extender_0_expanded_master_agent:rp_data
	...
	wire  [191:0] kernel_cra_s0_agent_rf_source_data;                                                         // kernel_cra_s0_agent:rf_source_data -> kernel_cra_s0_agent_rsp_fifo:in_data
	...
	wire  [191:0] kernel_cra_s0_agent_rsp_fifo_out_data;                                                      // kernel_cra_s0_agent_rsp_fifo:out_data -> kernel_cra_s0_agent:rf_sink_data
	...
	wire  [190:0] cmd_mux_src_data;                                                                           // cmd_mux:src_data -> kernel_cra_s0_agent:cp_data
	...
	wire  [190:0] address_span_extender_0_expanded_master_agent_cp_data;                                      // address_span_extender_0_expanded_master_agent:cp_data -> router:sink_data
	...
	wire  [190:0] router_src_data;                                                                            // router:src_data -> cmd_demux:sink_data
	...
	wire  [190:0] kernel_cra_s0_agent_rp_data;                                                                // kernel_cra_s0_agent:rp_data -> router_001:sink_data
	...
	wire  [190:0] router_001_src_data;                                                                        // router_001:src_data -> rsp_demux:sink_data
	...
	wire  [190:0] cmd_demux_src0_data;                                                                        // cmd_demux:src0_data -> crosser:in_data
	...
	wire  [190:0] crosser_out_data;                                                                           // crosser:out_data -> cmd_mux:sink0_data
	...
	wire  [190:0] rsp_demux_src0_data;                                                                        // rsp_demux:src0_data -> crosser_001:in_data
	...
	wire  [190:0] crosser_001_out_data;                                                                       // crosser_001:out_data -> rsp_mux:sink0_data
	...
	mpsim_ki_altera_merlin_master_agent_1940_6ued26y #(
		.PKT_WUNIQUE               (145),
		.PKT_DOMAIN_H              (144),
		.PKT_DOMAIN_L              (143),
		.PKT_SNOOP_H               (142),
		...
		.PKT_AWATOP_H              (169),
		.PKT_AWATOP_L              (164),
		.PKT_AWSTASHNID_H          (180),
		.PKT_AWSTASHNID_L          (170),
		.PKT_AWSTASHNIDEN          (181),
		.PKT_AWSTASHLPID_H         (186),
		.PKT_AWSTASHLPID_L         (182),
		.PKT_AWSTASHLPIDEN         (187),
		.PKT_MMUSECSID             (189),
		.PKT_MMUSID_H              (188),
		.PKT_MMUSID_L              (188),
		.PKT_DATALESS              (190),
		...
		.cp_data               (address_span_extender_0_expanded_master_agent_cp_data),                                      //  output,  width = 191,          .data
		...
		.rp_data               (rsp_mux_src_data),                                                                           //   input,  width = 191,          .data
	...
	mpsim_ki_altera_merlin_slave_agent_1930_jxauz3i #(
		...
		.rp_data                 (kernel_cra_s0_agent_rp_data),                    //  output,  width = 191,                .data
		...
		.cp_data                 (cmd_mux_src_data),                               //   input,  width = 191,                .data
		...
		.rf_sink_data            (kernel_cra_s0_agent_rsp_fifo_out_data),          //   input,  width = 192,                .data
		...
		.rf_source_data          (kernel_cra_s0_agent_rf_source_data),             //  output,  width = 192,                .data
	...
	mpsim_ki_altera_avalon_sc_fifo_1932_onpcouq #(
		...
		.clk               (kernel_clk_out_clk_clk),                         //   input,    width = 1,       clk.clk
		.reset             (kernel_cra_reset_reset_bridge_in_reset_reset),   //   input,    width = 1, clk_reset.reset
		.in_data           (kernel_cra_s0_agent_rf_source_data),             //   input,  width = 192,        in.data
		...
		.out_data          (kernel_cra_s0_agent_rsp_fifo_out_data),          //  output,  width = 192,       out.data
	...
	mpsim_ki_altera_merlin_router_1921_r63f3ii router (
		...
		.sink_data          (address_span_extender_0_expanded_master_agent_cp_data),          //   input,  width = 191,          .data
		...
		.src_data           (router_src_data),                                                //  output,  width = 191,          .data
		.src_channel        (router_src_channel),                                             //  output,    width = 1,          .channel
		.src_startofpacket  (router_src_startofpacket),                                       //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_src_endofpacket)                                          //  output,    width = 1,          .endofpacket
	);

	mpsim_ki_altera_merlin_router_1921_5o23cja router_001 (
		...
		.sink_data          (kernel_cra_s0_agent_rp_data),                  //   input,  width = 191,          .data
	...
	mpsim_ki_altera_merlin_demultiplexer_1921_2ykinqq cmd_demux (
		...
		.src0_data          (cmd_demux_src0_data),                                       //  output,  width = 191,          .data
		.src0_channel       (cmd_demux_src0_channel),                                    //  output,    width = 1,          .channel
		.src0_startofpacket (cmd_demux_src0_startofpacket),                              //  output,    width = 1,          .startofpacket
		.src0_endofpacket   (cmd_demux_src0_endofpacket)                                 //  output,    width = 1,          .endofpacket
	);

	mpsim_ki_altera_merlin_multiplexer_1922_3p4gbgy cmd_mux (
		.clk                 (kernel_clk_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset               (kernel_cra_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_src_ready),                            //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_src_valid),                            //  output,    width = 1,          .valid
		.src_data            (cmd_mux_src_data),                             //  output,  width = 191,          .data
		...
		.sink0_data          (crosser_out_data),                             //   input,  width = 191,          .data
	...
	mpsim_ki_altera_merlin_demultiplexer_1921_2ykinqq rsp_demux (
		.clk                (kernel_clk_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset              (kernel_cra_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_001_src_ready),                         //  output,    width = 1,      sink.ready
		.sink_channel       (router_001_src_channel),                       //   input,    width = 1,          .channel
		.sink_data          (router_001_src_data),                          //   input,  width = 191,          .data
		.sink_startofpacket (router_001_src_startofpacket),                 //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (router_001_src_endofpacket),                   //   input,    width = 1,          .endofpacket
		.sink_valid         (router_001_src_valid),                         //   input,    width = 1,          .valid
		.src0_ready         (rsp_demux_src0_ready),                         //   input,    width = 1,      src0.ready
		.src0_valid         (rsp_demux_src0_valid),                         //  output,    width = 1,          .valid
		.src0_data          (rsp_demux_src0_data),                          //  output,  width = 191,          .data
		.src0_channel       (rsp_demux_src0_channel),                       //  output,    width = 1,          .channel
		.src0_startofpacket (rsp_demux_src0_startofpacket),                 //  output,    width = 1,          .startofpacket
		.src0_endofpacket   (rsp_demux_src0_endofpacket)                    //  output,    width = 1,          .endofpacket
	);

	mpsim_ki_altera_merlin_multiplexer_1922_iunjqty rsp_mux (
		.clk                 (clk_reset_clk_clk),                                         //   input,    width = 1,       clk.clk
		.reset               (address_span_extender_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_src_ready),                                         //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_src_valid),                                         //  output,    width = 1,          .valid
		.src_data            (rsp_mux_src_data),                                          //  output,  width = 191,          .data
		...
		.sink0_data          (crosser_001_out_data),                                      //   input,  width = 191,          .data
	...
	mpsim_ki_hs_clk_xer_1941_ac5fhdy #(
		.DATA_WIDTH          (191),
		.BITS_PER_SYMBOL     (191),
		.USE_PACKETS         (1),
		.USE_CHANNEL         (1),
		...
		.in_data           (cmd_demux_src0_data),                                       //   input,  width = 191,              .data
		...
		.out_data          (crosser_out_data),                                          //  output,  width = 191,              .data
		.in_empty          (1'b0),                                                      // (terminated),                             
		.in_error          (1'b0),                                                      // (terminated),                             
		.out_empty         (),                                                          // (terminated),                             
		.out_error         ()                                                           // (terminated),                             
	...
	mpsim_ki_hs_clk_xer_1941_ac5fhdy #(
		...
		.in_data           (rsp_demux_src0_data),                                       //   input,  width = 191,              .data
		...
		.out_data          (crosser_001_out_data),                                      //  output,  width = 191,              .data
		.in_empty          (1'b0),                                                      // (terminated),                             
		.in_error          (1'b0),                                                      // (terminated),                             
		.out_empty         (),                                                          // (terminated),                             
		.out_error         ()                                                           // (terminated),                             
