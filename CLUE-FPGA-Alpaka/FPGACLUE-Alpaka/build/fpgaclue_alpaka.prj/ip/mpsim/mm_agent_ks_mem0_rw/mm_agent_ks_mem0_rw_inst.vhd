	component mm_agent_ks_mem0_rw is
		generic (
			USE_WRITE_ACK              : integer := 0;
			AV_ADDRESS_W               : integer := 41;
			...
			AV_MAX_PENDING_READS       : integer := 256;
		...
		port (
			...
			avs_burstcount    : in  std_logic_vector(0 downto 0)  := (others => 'X'); -- burstcount
			avs_readdata      : out std_logic_vector(63 downto 0);                    -- readdata
			avs_address       : in  std_logic_vector(40 downto 0) := (others => 'X'); -- address
	...
	end component mm_agent_ks_mem0_rw;

	u0 : component mm_agent_ks_mem0_rw
		generic map (
