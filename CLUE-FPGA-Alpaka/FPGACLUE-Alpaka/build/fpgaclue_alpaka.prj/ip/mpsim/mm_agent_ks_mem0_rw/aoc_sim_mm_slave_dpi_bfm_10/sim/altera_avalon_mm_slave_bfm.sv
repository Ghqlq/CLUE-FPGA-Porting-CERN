...
// $File: //acds/rel/25.1.1/ip/iconnect/verification/altera_avalon_mm_slave_bfm/altera_avalon_mm_slave_bfm.sv $
// $File: //acds/rel/25.1.1/ip/iconnect/verification/altera_avalon_mm_slave_bfm/altera_avalon_mm_slave_bfm.sv $
// $Revision: #1 $
// $Date: 2025/04/24 $
// $Author: psgswbuild $
...
module altera_avalon_mm_slave_bfm(
   ...
   parameter AV_WAITREQUEST_TIMEOUT   = 2048; // Controls the waitrequest allowance value
...
BFM will reset the wait cycles to 1");
   ...
   function automatic void __hello();
      ...
      print(VERBOSITY_INFO, message);            
      $sformat(message, "%m: -   $Date: 2025/04/24 $");
      print(VERBOSITY_INFO, message);
...
`pragma questa_oem_00 ""
`endif