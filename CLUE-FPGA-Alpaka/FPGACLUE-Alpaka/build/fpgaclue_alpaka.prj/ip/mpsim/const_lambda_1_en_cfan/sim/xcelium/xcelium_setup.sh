...
TOP_LEVEL_NAME="const_lambda_1_en_cfan.const_lambda_1_en_cfan"
QSYS_SIMDIR="./../"
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [const_lambda_1_en_cfan::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [const_lambda_1_en_cfan::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set libraries [dict merge $libraries [const_lambda_1_en_cfan::get_design_libraries]]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [const_lambda_1_en_cfan::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [const_lambda_1_en_cfan::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
