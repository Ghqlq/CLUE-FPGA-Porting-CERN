...
TOP_LEVEL_NAME="kernel_system_fpgaclue_alpaka_sys.kernel_system_fpgaclue_alpaka_sys"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/data/CMS_CLUE/altera/Quartus/25.1.1/quartus/"
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [kernel_system_fpgaclue_alpaka_sys::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [kernel_system_fpgaclue_alpaka_sys::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set libraries [dict merge $libraries [kernel_system_fpgaclue_alpaka_sys::get_design_libraries]]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set design_files [dict merge $design_files [kernel_system_fpgaclue_alpaka_sys::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set files [concat $files [kernel_system_fpgaclue_alpaka_sys::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
