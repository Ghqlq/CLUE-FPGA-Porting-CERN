...
# ACDS 25.1.1 125 linux 2026.08.11.16:49:55
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     kernel_system_fpgaclue_alpaka_sys
# 
...
# ----------------------------------------
# If kernel_system_fpgaclue_alpaka_sys is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "kernel_system_fpgaclue_alpaka_sys.kernel_system_fpgaclue_alpaka_sys"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/data/CMS_CLUE/altera/Quartus/25.1.1/quartus/"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [kernel_system_fpgaclue_alpaka_sys::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [kernel_system_fpgaclue_alpaka_sys::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [kernel_system_fpgaclue_alpaka_sys::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [kernel_system_fpgaclue_alpaka_sys::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
  ...
  set normalized_src [kernel_system_fpgaclue_alpaka_sys::normalize_path "$file"]
  set normalized_dest [kernel_system_fpgaclue_alpaka_sys::normalize_path "$dest_file"]
...
set logical_libraries [list "work" "work_lib" "lpm_ver" "sgate_ver" "altera_ver" "altera_mf_ver" "altera_lnsim_ver" "tennm_ver" "tennm_hssi_ver" "tennm_fm_hps_ver" "tennm_hssi_f1_ver"]
...
set libraries [dict merge $libraries [kernel_system_fpgaclue_alpaka_sys::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [kernel_system_fpgaclue_alpaka_sys::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [kernel_system_fpgaclue_alpaka_sys::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [kernel_system_fpgaclue_alpaka_sys::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
