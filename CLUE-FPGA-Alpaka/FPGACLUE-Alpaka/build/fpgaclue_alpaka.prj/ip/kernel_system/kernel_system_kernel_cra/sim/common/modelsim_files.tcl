...
namespace eval kernel_system_kernel_cra {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_avalon_mm_bridge_2010/sim/kernel_system_kernel_cra_altera_avalon_mm_bridge_2010_tex5a4i.v"]\"  -work altera_avalon_mm_bridge_2010"
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/kernel_system_kernel_cra.v"]\"  -work kernel_system_kernel_cra"                                                                             
    return $design_files
  }
